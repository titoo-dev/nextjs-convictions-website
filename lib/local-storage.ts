...
export const petitionLocalStorage = {
	save: (data: PetitionFormData): void => {
		try {
			...
			console.warn(
				'Failed to save petition form data to localStorage:',
				error
			);
		}
	},
	...
	load: (): PetitionFormData | null => {
		try {
			...
			console.warn(
				'Failed to load petition form data from localStorage:',
				error
			);
	...
	clear: (): void => {
		try {
			...
			console.warn(
				'Failed to clear petition form data from localStorage:',
				error
			);
		}
	},
	...
	exists: (): boolean => {
		try {
			...
			console.warn(
				'Failed to check petition form data in localStorage:',
				error
			);
			return false;
		}
